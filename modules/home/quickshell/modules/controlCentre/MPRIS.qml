...
Rectangle {
    ...
    property real progress: root.player.positionSupported ? (root.player.position / root.player.length) : 0
    ...
    ColumnLayout {
        ...
        RowLayout {
            Icon {
                icon: "skip_previous"
                color: root.player.canGoPrevious ? Colors.text : Colors.surface2
                font.pixelSize: 25
            ...
            Icon {
                icon: "skip_next"
                color: root.player.canGoNext ? Colors.text : Colors.surface2
                font.pixelSize: 25
